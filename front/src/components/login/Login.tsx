...
const Login = () => {
  ...
  return (
    <section className="">
       <SignInSignUpHeader />
      <div className="signUp-login  flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="w-full bg-black opacity-80 text-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-600 dark:border-gray-700">
