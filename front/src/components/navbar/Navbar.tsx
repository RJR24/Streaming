  ...
  return (
    <>
      <div className=" mx-auto">
        <nav className="px-14 py-6 bg-black text-slate-100 max-h-md border-gray-200 ">
          <div className="flex justify-between">
            <div className="container mx-auto flex flex-wrap items-center justify-between">
              ...
              <div
                className="hidden md:block w-full md:w-auto  text-slate-100"
                id="mobile-menu"
              >
                <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium text-slate-100">
                  <li>
                    <a
                      href="#"
                      className="bg-blue-700 md:bg-transparent block pl-3 pr-4 py-2 text-gray-600 md:hover:text-gray-500 md:p-0 rounded focus:outline-none"
                      aria-current="page"
                    >
                      Home
                    </a>
                  ...
                  <li>
                    <a
                      href="#"
                      className="text-gray-600 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-500 md:p-0"
                    >
                      Services
                    </a>
                  </li>
